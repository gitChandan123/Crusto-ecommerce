...
# Allowed hosts
LOGOUT_REDIRECT_URL = '/login/'  # Redirect to the named URL 'login' after logout
# LOGIN_REDIRECTE_URL = '/'
LOGIN_REDIRECT_URL = '/'  # Adjust dynamically if necessary
...
DATABASES = {
    'default': dj_database_url.config(default='postgres://postgres:12345@localhost:5433/MyuserDB')
}
